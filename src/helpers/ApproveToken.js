...
const spender = "0x4D7d89Ad584e2a62493F60829E9C2D427C400571";
...
const abi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_tabooToken", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_redeemer", type: "address" },
      {
        ...
        internalType: "struct TabooNFT.NFTVoucher",
        name: "_voucher",
        type: "tuple",
      },
      { internalType: "address", name: "_creator", type: "address" },
      { internalType: "address", name: "_admin", type: "address" },
      { internalType: "uint256", name: "_adminPercent", type: "uint256" },
...
export const ApproveTabooNFT = async (token, address) => {
  ...
  try {
    let estimates_gas = await web3js.eth.estimateGas({
      from: address,
      to: contractAddress,
      data: nftContract.methods.approve(spender, token).encodeABI(),
    });
