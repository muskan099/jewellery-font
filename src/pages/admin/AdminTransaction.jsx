                  ...
                  <InputGroup>
                    <FormControl
                     ...
                     <FormControl
                      ...
                      <div  className="nav-btn gradient-btn" onClick={(e) => {
                        e.preventDefault();
                        setSubmit(true)
                        setIsVisible(false)
                        setIsVisible1(false)
                        setcurrent_date(moment(startDate, "YYYY-MM-DD").format().slice(0,10));
                        setcurrent_date1(moment(endDate, "YYYY-MM-DD").format().slice(0,10));
